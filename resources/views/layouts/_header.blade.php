...
<header class="navbar navbar-expand navbar-dark flex-column flex-md-row bd-navbar ">
	<a class="navbar-brand mr-0 mr-md-2" href="http://ohayviec.com/home" id="logo-ohay">Ohayviec
	</a>

	<div class="navbar-nav-scroll">
		<ul class="navbar-nav bd-navbar-nav flex-row">
			<li class="nav-item">
				<a class="nav-link " href="http://ohayviec.com/home">Trang chủ</a>
			</li>
			<li class="nav-item">
		...
		<ul class="navbar-nav flex-row ml-md-auto d-none d-md-flex">
			...
			<li class="nav-item">
				<div class="nav-item-avatar">
					...
					@else 
					<a href="http://ohayviec.com/account/login" style="max-height: 40px; line-height: 22px;" class="btn btn-success btn-login">
						<span >Đăng Nhập</span>
					</a>
					<a href="http://ohayviec.com/account/register" style="max-height: 40px; line-height: 22px;" class="btn btn-success btn-register">
						<span>Đăng Kí</span>
					</a>    
					@endif
				</div>
